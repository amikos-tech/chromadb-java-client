...
/**
 * Default stop words for BM25 tokenization, matching Go client's
 * {@code DEFAULT_CHROMA_BM25_STOPWORDS} (174 NLTK English stop words).
 */
public final class BM25StopWords {

    /**
     * Unmodifiable set of 174 NLTK English stop words matching the Go client.
     */
    public static final Set<String> DEFAULT = Collections.unmodifiableSet(new HashSet<>(Arrays.asList(
